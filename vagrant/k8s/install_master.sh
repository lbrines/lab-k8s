...
kubeadm init --kubernetes-version=${KUBE_VERSION} --ignore-preflight-errors=NumCPU --skip-token-print --pod-network-cidr 192.168.0.0/16 --apiserver-advertise-address 192.168.56.11

mkdir -p ~/.kube
sudo cp -i /etc/kubernetes/admin.conf ~/.kube/config
sudo mkdir /home/vagrant/.kube/ && sudo cp -i /etc/kubernetes/admin.conf /home/vagrant/.kube/config
